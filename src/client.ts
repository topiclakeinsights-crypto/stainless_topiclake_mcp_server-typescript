...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['STAINLESS_TOPICLAKE_MCP_SERVER_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['STAINLESS_TOPICLAKE_MCP_SERVER_LOG'] or 'warn' if it isn't set.
   */
 ...
 */
export class StainlessTopiclakeMcpServer {
  apiKey: string;
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? StainlessTopiclakeMcpServer.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(
        readEnv('STAINLESS_TOPICLAKE_MCP_SERVER_LOG'),
        "process.env['STAINLESS_TOPICLAKE_MCP_SERVER_LOG']",
        this,
      ) ??
      defaultLogLevel;
  ...
  static StainlessTopiclakeMcpServer = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static StainlessTopiclakeMcpServerError = Errors.StainlessTopiclakeMcpServerError;
...
StainlessTopiclakeMcpServer.Policyinsights = Policyinsights;

export declare namespace StainlessTopiclakeMcpServer {
