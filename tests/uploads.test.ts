import fs from 'fs';
import type { ResponseLike } from 'stainless_topiclake_mcp_server/internal/to-file';
import { toFile } from 'stainless_topiclake_mcp_server/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('stainless_topiclake_mcp_server/core/uploads');
    await expect(
