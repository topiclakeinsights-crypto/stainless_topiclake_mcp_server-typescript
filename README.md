# Stainless Topiclake Mcp Server TypeScript API Library
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/stainless_topiclake_mcp_server-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install stainless_topiclake_mcp_server`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/stainless_topiclake_mcp_server-typescript/issues) with questions, bugs, or suggestions.
